...
class MedicalCentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_center" do
    assert_difference('MedicalCenter.count') do
      post medical_centers_url, params: { medical_center: { address: @medical_center.address, description: @medical_center.description, name: @medical_center.name, phone_number: @medical_center.phone_number, worker_id: @medical_center.worker_id } }
    end
  ...
  test "should update medical_center" do
    patch medical_center_url(@medical_center), params: { medical_center: { address: @medical_center.address, description: @medical_center.description, name: @medical_center.name, phone_number: @medical_center.phone_number, worker_id: @medical_center.worker_id } }
