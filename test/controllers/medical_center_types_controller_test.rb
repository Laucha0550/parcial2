...
class MedicalCenterTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_center_type" do
    assert_difference('MedicalCenterType.count') do
      post medical_center_types_url, params: { medical_center_type: { description: @medical_center_type.description, medical_center_id: @medical_center_type.medical_center_id, name: @medical_center_type.name } }
    end
  ...
  test "should update medical_center_type" do
    patch medical_center_type_url(@medical_center_type), params: { medical_center_type: { description: @medical_center_type.description, medical_center_id: @medical_center_type.medical_center_id, name: @medical_center_type.name } }
